...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Scamcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"scamcoin.com", "217.182.226.18"},
	{"217.182.226.18", "217.182.226.18"},
	{"scamdevelop.com", "188.226.3.204"},
	{"188.226.3.204", "188.226.3.204"},
	{NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    ...
    0x8e2eddb0, 0x09daf150, 0x8a67c7c6, 0x22a9e52e, 0x05cff476, 0xc99b2f4e, 0x0f183b25, 0xd0335793,
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Scamcoin is probably already running."), addrBind.ToString().c_str());
        else
